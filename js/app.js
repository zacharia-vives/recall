...
import * as speech from "./speech.js?v=21";
import * as camera from "./camera.js?v=21";
import * as ocr from "./ocr.js?v=21";
import { isConfigured } from "./config.js?v=21";
import * as install from "./install.js?v=21";
import * as lock from "./lock.js?v=21";
...
async function showWhoHasAccess() {
  ...
  try {
    const cloud = await import("./cloud.js?v=21");
...
async function syncHousehold(options) {
  ...
  let cloud;
  try {
    cloud = await import("./cloud.js?v=21");
  } catch (err) {
