...
import * as speech from "./speech.js?v=43";
import * as camera from "./camera.js?v=43";
import * as ocr from "./ocr.js?v=43";
import { isConfigured, NOTICE_VERSION } from "./config.js?v=43";
import * as install from "./install.js?v=43";
import * as lock from "./lock.js?v=43";
import * as i18n from "./i18n.js?v=43";
import * as docs from "./docs.js?v=43";
import * as skins from "./skins.js?v=43";
...
async function showWhoHasAccess() {
  ...
  try {
    const cloud = await import("./cloud.js?v=43");
...
async function drawVoices() {
  ...
  try {
    const voices = await import("./voices.js?v=43");
...
async function syncHousehold(options) {
  ...
  let cloud;
  try {
    cloud = await import("./cloud.js?v=43");
  } catch (err) {
