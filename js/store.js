  ...
  const examples = [
    {
      id: newId(),
      kind: "letter",
      title: "Cardiologie, controle",
      people: ["dokter Vermeulen", "Marie (dochter)"],
      place: "AZ Groeninge, Kortrijk",
      happensAt: tomorrow.toISOString(),
      tags: ["afspraak", "hart"],
      remind: "day-before",
      spokenText: "Je afspraak bij de cardioloog is morgen om tien uur in AZ Groeninge.",
      ocrText: "",
      hasPhoto: false,
    ...
    },
    {
      id: newId(),
      kind: "person",
      title: "Marie, je dochter",
      people: ["Marie"],
      place: "Gent",
      happensAt: "",
      tags: ["familie"],
      remind: "",
      spokenText: "Dit is Marie, je dochter. Ze belde dinsdagavond.",
      ocrText: "",
      hasPhoto: false,
    ...
    },
    {
      id: newId(),
      kind: "place",
      title: "Het bankje aan Sint-Anna",
      people: ["Jan", "Marie"],
      place: "Sint-Annapark",
      happensAt: "",
      tags: ["1963"],
      remind: "",
      spokenText: "Het bankje aan Sint-Anna, waar jij en Jan in 1963 zaten.",
      ocrText: "",
      hasPhoto: false,
