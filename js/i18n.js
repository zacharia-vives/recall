...
const WORDS = {
  ...
  "lang.hint":           { en: "Recall writes and speaks in this language. Pick the one she reads her post in.",
                           nl: "Recall schrijft en spreekt in deze taal. Kies de taal waarin zij haar post leest.",
                           fr: "Recall écrit et parle dans cette langue. Choisissez celle dans laquelle elle lit son courrier." },
  ...
  "voice.hint":          { en: "Phones come with several. Try them and leave the one she likes: it is the voice she will hear every day. Only voices that speak on the phone itself are offered, so a letter is never sent away to be read.",
                           nl: "Telefoons hebben er meerdere. Probeer ze en laat de stem staan die zij graag hoort: het is de stem die zij elke dag hoort. Alleen stemmen die op de telefoon zelf spreken worden aangeboden, zodat een brief nooit wordt weggestuurd om gelezen te worden.",
                           fr: "Les téléphones en ont plusieurs. Essayez-les et laissez celle qu'elle aime : c'est la voix qu'elle entendra chaque jour. Seules les voix qui parlent sur le téléphone même sont proposées, ainsi une lettre n'est jamais envoyée ailleurs pour être lue." },
  ...
  "code.hint":           { en: "Only if it is wanted. She has to be able to use this phone alone, so nothing here is compulsory, and the code never locks her out for good: you can always unlock the phone with a fresh phone code from the family app.",
                           nl: "Alleen als het gewenst is. Zij moet deze telefoon alleen kunnen gebruiken, dus niets hiervan is verplicht, en de code sluit haar nooit definitief buiten: u kunt de telefoon altijd ontgrendelen met een nieuwe telefooncode uit de familie-app.",
                           fr: "Seulement si vous le souhaitez. Elle doit pouvoir utiliser ce téléphone seule, donc rien ici n'est obligatoire, et le code ne l'enferme jamais dehors : vous pouvez toujours déverrouiller le téléphone avec un nouveau code de l'application famille." },
  ...
  "h.myname":            { en: "Your own name, so she can see who helps", nl: "Uw eigen naam, zodat zij ziet wie helpt", fr: "Votre nom, pour qu'elle voie qui aide" },
  ...
  "h.remindher":         { en: "Remind her", nl: "Herinner haar", fr: "La rappeler" },
  ...
  "h.remindhint":        { en: "A reminder waits on her Today screen and is read out loud when she opens Recall. Recall cannot make a closed phone ring, so for something that really matters, call her as well.",
                           nl: "Een herinnering wacht op haar scherm Vandaag en wordt voorgelezen als zij Recall opent. Recall kan een gesloten telefoon niet laten rinkelen, dus bel haar ook voor iets dat echt belangrijk is.",
                           fr: "Un rappel attend sur son écran Aujourd'hui et est lu à voix haute quand elle ouvre Recall. Recall ne peut pas faire sonner un téléphone fermé, donc pour quelque chose de vraiment important, appelez-la aussi." },
  ...
  "h.phones":            { en: "Her phones", nl: "Haar telefoons", fr: "Ses téléphones" },
  "h.setupphone":        { en: "Set up a phone", nl: "Een telefoon instellen", fr: "Configurer un téléphone" },
  "h.step1":             { en: "1. What happens", nl: "1. Wat er gebeurt", fr: "1. Ce qui se passe" },
  "h.step2":             { en: "2. Show her the square", nl: "2. Toon haar het vierkant", fr: "2. Montrez-lui le carré" },
  "h.step3":             { en: "3. Finish", nl: "3. Afronden", fr: "3. Terminer" },
  "h.w1":                { en: "Her cards live in the household, not on the phone, so a new phone has everything the moment it is linked. Nothing is copied and nothing is lost. The old phone keeps working until you remove it here, which is the last step.",
                           nl: "Haar kaarten staan in het huishouden, niet op de telefoon, dus een nieuwe telefoon heeft alles zodra hij gekoppeld is. Er wordt niets gekopieerd en er gaat niets verloren. De oude telefoon blijft werken tot u hem hier verwijdert, en dat is de laatste stap.",
                           fr: "Ses fiches vivent dans le foyer, pas sur le téléphone, donc un nouveau téléphone a tout dès qu'il est relié. Rien n'est copié et rien n'est perdu. L'ancien téléphone continue de fonctionner jusqu'à ce que vous le retiriez ici, ce qui est la dernière étape." },
  "h.phonename":         { en: "What to call this phone", nl: "Hoe deze telefoon heet", fr: "Comment appeler ce téléphone" },
  ...
  "h.w2":                { en: "On her phone, open the camera and point it at this square. It opens Recall and links the phone. If the camera will not cooperate, she can type the six letters instead. Both are good for fifteen minutes.",
                           nl: "Open op haar telefoon de camera en richt op dit vierkant. Dat opent Recall en koppelt de telefoon. Als de camera niet meewerkt, kan zij ook de zes letters typen. Beide blijven vijftien minuten geldig.",
                           fr: "Sur son téléphone, ouvrez la caméra et dirigez-la vers ce carré. Cela ouvre Recall et relie le téléphone. Si la caméra ne coopère pas, elle peut taper les six lettres. Les deux sont valables quinze minutes." },
  "h.waiting":           { en: "Waiting for her phone.", nl: "Wachten op haar telefoon.", fr: "En attente de son téléphone." },
  ...
  "h.logthepoint":       { en: "She can read this list too. That is the point of it.",
                           nl: "Zij kan deze lijst ook lezen. Dat is juist de bedoeling.",
                           fr: "Elle peut lire cette liste aussi. C'est justement le but." },
  "h.backtokeeper":      { en: "Back to the keeper app", nl: "Terug naar de app van haar", fr: "Retour à son application" },
  ...
  "run.deleteask":       { en: "This card and its photo will be deleted. Are you sure?",
                           nl: "Deze kaart en haar foto worden verwijderd. Weet u het zeker?",
  ...
  "run.facelook":        { en: "Ask her to look at the phone.", nl: "Vraag haar naar de telefoon te kijken.", fr: "Demandez-lui de regarder le téléphone." },
  ...
  "hrun.qrfailed":       { en: "Let her type the six letters, the square did not load.",
                           nl: "Laat haar de zes letters typen, het vierkant is niet geladen.",
                           fr: "Laissez-la taper les six lettres, le carré ne s'est pas affiché." },
  ...
  "hrun.phoneset":       { en: "Her phone is set up.", nl: "Haar telefoon is ingesteld.", fr: "Son téléphone est configuré." },
  ...
  "hrun.removeask":      { en: "Remove {name}? She will see that this happened.",
                           nl: "{name} verwijderen? Zij zal zien dat dit gebeurd is.",
                           fr: "Retirer {name} ? Elle verra que cela s'est passé." },
