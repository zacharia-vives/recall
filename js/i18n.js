...
const WORDS = {
  ...
  /* P23. What the family has done, on her own phone. The notice she hears out
     loud says everything they do is written down where she can read it, and
     until now that list only existed in the family app. A promise made out
     loud has to be answerable in the interface that made it. */
  ...
  /* N18. The twenty four skins. A skin is a palette, a face, a shape and a
     layout, and every one of them was measured against the 4.5:1 rule before
     it was offered, so there is nothing in this list she can pick that makes
     her own app unreadable. The names are hers to read, so they are
     translated like everything else. */
  "look.heading":        { en: "How Recall looks",
                           nl: "Hoe Recall eruitziet",
                           fr: "L'apparence de Recall" },
  "look.hint":           { en: "Twenty four ways to show the same cards. Every one of them was checked so the words stay easy to read, so pick whichever is easiest on your eyes.",
                           nl: "Vierentwintig manieren om dezelfde kaarten te tonen. Ze zijn allemaal nagekeken zodat de woorden goed leesbaar blijven, dus kies wat het aangenaamst is voor je ogen.",
                           fr: "Vingt quatre façons de montrer les mêmes cartes. Toutes ont été vérifiées pour que les mots restent faciles à lire, donc choisissez ce qui repose le plus vos yeux." },
  "look.label":          { en: "The look", nl: "Het uitzicht", fr: "L'apparence" },
  "look.now":            { en: "Now showing: {name}",
                           nl: "Nu ingesteld: {name}",
                           fr: "Actuellement: {name}" },
  "look.bigger":         { en: "This one makes everything a size bigger.",
                           nl: "Deze maakt alles een maat groter.",
                           fr: "Celle-ci agrandit tout d'un cran." },
  "look.reset":          { en: "Back to the ordinary look",
                           nl: "Terug naar het gewone uitzicht",
                           fr: "Revenir à l'apparence habituelle" },
  "look.rest":           { en: "Show the other {n}",
                           nl: "Toon de andere {n}",
                           fr: "Afficher les {n} autres" },

  "lookgroup.daylight":         { en: "For daylight",
                           nl: "Voor bij daglicht",
                           fr: "Pour la journée" },
  "lookgroup.night":            { en: "For evening and night",
                           nl: "Voor 's avonds en 's nachts",
                           fr: "Pour le soir et la nuit" },
  "lookgroup.lowvision":        { en: "For when seeing is hard",
                           nl: "Voor als zien moeilijk gaat",
                           fr: "Quand voir est difficile" },

  "skin.warm-paper":      { en: "Warm paper",
                           nl: "Warm papier",
                           fr: "Papier chaud" },
  "skin.sand":            { en: "Sand",
                           nl: "Zand",
  ...
  "skin.night":           { en: "Night",
                           nl: "Nacht",
                           fr: "Nuit" },
  "skin.broadsheet":      { en: "Newspaper",
                           nl: "Krant",
                           fr: "Journal" },
  "skin.lamp":            { en: "Lamplight",
                           nl: "Lamplicht",
                           fr: "Lumière de lampe" },
  "skin.large-serif":     { en: "Large print",
                           nl: "Grote letter",
                           fr: "Gros caractères" },
  "skin.blue-accent":     { en: "Blue",
                           nl: "Blauw",
                           fr: "Bleu" },
  "skin.amber-night":     { en: "Amber night",
                           nl: "Amber nacht",
                           fr: "Nuit ambre" },
  "skin.forest":          { en: "Forest",
                           nl: "Bos",
                           fr: "Forêt" },
  "skin.appointment-slip": { en: "Appointment slip",
                           nl: "Afsprakenbriefje",
                           fr: "Fiche de rendez-vous" },
  "skin.night-slip":      { en: "Night slip",
                           nl: "Nachtbriefje",
                           fr: "Fiche de nuit" },
  "skin.pale-gold":       { en: "Pale gold",
                           nl: "Zacht goud",
                           fr: "Or pâle" },
  "skin.day-plan":        { en: "The day in order",
                           nl: "De dag op een rij",
                           fr: "La journée en ordre" },
  "skin.departures":      { en: "Departures board",
                           nl: "Vertrekbord",
                           fr: "Tableau des départs" },
  "skin.strong-dark":     { en: "Strong dark",
                           nl: "Sterk donker",
                           fr: "Fort et sombre" },
  "skin.terracotta":      { en: "Terracotta",
                           nl: "Terracotta",
                           fr: "Terre cuite" },
  "skin.block":           { en: "Block",
                           nl: "Blok",
                           fr: "Bloc" },
  "skin.amber-on-black":  { en: "Amber on black",
                           nl: "Amber op zwart",
                           fr: "Ambre sur noir" },
  "skin.calm":            { en: "Calm",
                           nl: "Rustig",
  ...
  "skin.plum":            { en: "Plum",
                           nl: "Pruim",
                           fr: "Prune" },
  "skin.the-next-thing":  { en: "One thing at a time",
                           nl: "Eén ding tegelijk",
                           fr: "Une chose à la fois" },
  "skin.two-tiles":       { en: "Two tiles",
                           nl: "Twee tegels",
                           fr: "Deux tuiles" },
  "skin.strong-light":    { en: "Strong light",
                           nl: "Sterk licht",
                           fr: "Fort et clair" },
  "skin.quiet-stone":     { en: "Quiet stone",
                           nl: "Stille steen",
                           fr: "Pierre calme" },
  "skin.sober-white":    { en: "Sober white",
                           nl: "Sober wit",
                           fr: "Blanc sobre" },
  "skin.sober-dark":     { en: "Sober dark",
                           nl: "Sober donker",
                           fr: "Sombre sobre" },
  "better.heading":      { en: "A better voice",
                           nl: "Een betere stem",
                           fr: "Une meilleure voix" },
  "better.hint":         { en: "Recall reads with a natural voice that it fetches once, about {mb} MB, over wifi. After that it works with no internet at all. The voice runs on this device: nothing you have Recall read is ever sent anywhere. Until it has been fetched, and if anything goes wrong with it, Recall reads with the phone's own voice instead.",
                           nl: "Recall leest voor met een natuurlijke stem die ze één keer ophaalt, ongeveer {mb} MB, via wifi. Daarna werkt ze helemaal zonder internet. De stem werkt op dit toestel: niets van wat je laat voorlezen wordt ooit ergens naartoe gestuurd. Zolang ze niet opgehaald is, en als er iets mee misgaat, leest Recall voor met de eigen stem van de telefoon.",
                           fr: "Recall lit avec une voix naturelle qu'il télécharge une fois, environ {mb} MB, en wifi. Ensuite elle fonctionne sans aucune connexion. La voix tourne sur cet appareil: rien de ce que vous faites lire n'est jamais envoyé ailleurs. Tant qu'elle n'est pas téléchargée, et si quelque chose ne va pas, Recall lit avec la voix du téléphone." },
  "better.use":          { en: "Read with the better voice",
                           nl: "Voorlezen met de betere stem",
                           fr: "Lire avec la meilleure voix" },
  "better.get":          { en: "Fetch the voice now, {mb} MB",
                           nl: "De stem nu ophalen, {mb} MB",
                           fr: "Télécharger la voix maintenant, {mb} MB" },
  "better.getting":      { en: "Downloading, {pct} per cent. You can leave this screen open.",
                           nl: "Aan het downloaden, {pct} procent. Je mag dit scherm open laten staan.",
                           fr: "Téléchargement, {pct} pour cent. Vous pouvez laisser cet écran ouvert." },
  "better.ready":        { en: "The voice is on this device and Recall is reading with it.",
                           nl: "De stem staat op dit toestel en Recall leest er nu mee voor.",
                           fr: "La voix est sur cet appareil et Recall lit avec elle." },
  "better.readyoff":     { en: "The voice is on this device but switched off, so Recall is using the phone's own voice.",
                           nl: "De stem staat op dit toestel maar staat uit, dus Recall gebruikt de eigen stem van de telefoon.",
                           fr: "La voix est sur cet appareil mais désactivée, donc Recall utilise la voix du téléphone." },
  "better.notyet":       { en: "The voice for this language is not downloaded yet, so Recall is using the phone's own voice for now.",
                           nl: "De stem voor deze taal is nog niet gedownload, dus Recall gebruikt voorlopig de eigen stem van de telefoon.",
                           fr: "La voix pour cette langue n'est pas encore téléchargée, donc Recall utilise pour l'instant la voix du téléphone." },
  "better.failed":       { en: "That did not work, so Recall is still using the phone's own voice. Nothing is broken: try again when you have a better connection.",
                           nl: "Dat is niet gelukt, dus Recall gebruikt nog altijd de eigen stem van de telefoon. Er is niets stuk: probeer opnieuw met een betere verbinding.",
                           fr: "Cela n'a pas fonctionné, donc Recall utilise toujours la voix du téléphone. Rien n'est cassé: réessayez avec une meilleure connexion." },
  "better.cannot":       { en: "This phone's browser cannot run the better voice, so Recall uses the phone's own voice. Everything works as normal.",
                           nl: "De browser van deze telefoon kan de betere stem niet gebruiken, dus Recall gebruikt de eigen stem van de telefoon. Alles werkt gewoon.",
                           fr: "Le navigateur de ce téléphone ne peut pas utiliser la meilleure voix, donc Recall utilise la voix du téléphone. Tout fonctionne normalement." },
  "better.switchedoff":  { en: "The better voice is switched off, so Recall is reading with the phone's own voice.",
                           nl: "De betere stem staat uit, dus Recall leest voor met de eigen stem van de telefoon.",
                           fr: "La meilleure voix est désactivée, donc Recall lit avec la voix du téléphone." },
  "better.waiting":      { en: "Recall is waiting for wifi before fetching the voice, because it is about {mb} MB. Until then it reads with the phone's own voice. You can fetch it now with the button above.",
                           nl: "Recall wacht op wifi om de stem te halen, want ze is ongeveer {mb} MB. Tot dan leest Recall voor met de eigen stem van de telefoon. Met de knop hierboven kan je ze nu al halen.",
                           fr: "Recall attend le wifi pour télécharger la voix, car elle fait environ {mb} MB. En attendant, il lit avec la voix du téléphone. Le bouton ci-dessus la télécharge tout de suite." },
  "better.tryit":        { en: "Hear it", nl: "Beluister ze", fr: "Écoutez-la" },
  "better.sample":       { en: "This is the voice Recall will read your cards with.",
                           nl: "Dit is de stem waarmee Recall je kaarten zal voorlezen.",
                           fr: "C'est la voix avec laquelle Recall lira vos cartes." },
  "better.remove":       { en: "Remove it and free up the space",
                           nl: "Ze verwijderen en de ruimte vrijmaken",
                           fr: "La supprimer et libérer la place" },
  "seen.heading":        { en: "What your family has done",
                           nl: "Wat je familie gedaan heeft",
                           fr: "Ce que votre famille a fait" },
  "seen.hint":           { en: "Everything the people helping you have done, most recent first. They cannot see the same list about you: what you do on this phone is nobody else's business.",
                           nl: "Alles wat de mensen die je helpen gedaan hebben, het laatste eerst. Zij kunnen zo geen lijst over jou bekijken: wat jij op deze telefoon doet, is van niemand anders.",
                           fr: "Tout ce que les personnes qui vous aident ont fait, le plus récent d'abord. Elles ne peuvent pas voir la même liste à votre sujet: ce que vous faites sur ce téléphone ne regarde personne." },
  "seen.none":           { en: "Nothing yet.",
                           nl: "Nog niets.",
                           fr: "Rien pour l'instant." },
  "seen.notshared":      { en: "Nothing is shared with anybody, so there is nothing to show here.",
                           nl: "Er wordt met niemand iets gedeeld, dus hier is niets te zien.",
                           fr: "Rien n'est partagé avec personne, il n'y a donc rien à montrer ici." },
  "seen.offline":        { en: "This list lives with your family's cards, so it needs the internet. Try again when you are back online.",
                           nl: "Deze lijst staat bij de kaarten van je familie en heeft dus internet nodig. Probeer opnieuw als je weer online bent.",
                           fr: "Cette liste se trouve avec les cartes de votre famille et a donc besoin d'internet. Réessayez une fois reconnecté." },
  "seen.someone":        { en: "Someone", nl: "Iemand", fr: "Quelqu'un" },
  "seen.system":         { en: "A connected system", nl: "Een aangesloten systeem", fr: "Un système connecté" },
  "seen.added":          { en: "{who} added a card", nl: "{who} heeft een kaart toegevoegd", fr: "{who} a ajouté une carte" },
  "seen.edited":         { en: "{who} changed a card", nl: "{who} heeft een kaart aangepast", fr: "{who} a modifié une carte" },
  "seen.deleted":        { en: "{who} put a card in the bin", nl: "{who} heeft een kaart in de bak gelegd", fr: "{who} a mis une carte à la corbeille" },
  "seen.restored":       { en: "{who} took a card back out of the bin", nl: "{who} heeft een kaart weer uit de bak gehaald", fr: "{who} a ressorti une carte de la corbeille" },
  "seen.reminder_set":   { en: "{who} set a reminder", nl: "{who} heeft een herinnering gezet", fr: "{who} a posé un rappel" },
  "seen.marked_done":    { en: "{who} marked something as done", nl: "{who} heeft iets als gedaan aangeduid", fr: "{who} a marqué quelque chose comme fait" },
  "seen.invited":        { en: "{who} let somebody in to help", nl: "{who} heeft iemand binnengelaten om te helpen", fr: "{who} a laissé entrer quelqu'un pour aider" },
  "seen.removed":        { en: "{who} removed somebody", nl: "{who} heeft iemand verwijderd", fr: "{who} a retiré quelqu'un" },
  "seen.linked":         { en: "{who} linked a device", nl: "{who} heeft een toestel gekoppeld", fr: "{who} a lié un appareil" },
  "seen.unlinked":       { en: "{who} unlinked a device", nl: "{who} heeft een toestel ontkoppeld", fr: "{who} a délié un appareil" },
  ...
  "share.off":           { en: "Sharing is off. Your family cannot see your cards.",
                           nl: "Delen staat uit. Je familie kan je kaarten niet zien.",
                           fr: "Le partage est desactive. Votre famille ne voit pas vos cartes." },
  "share.againbtn":      { en: "Share with my family again",
                           nl: "Weer delen met mijn familie",
                           fr: "Partager de nouveau avec ma famille" },
  "share.againask":      { en: "Let your family see your cards again?",
                           nl: "Je familie je kaarten weer laten zien?",
                           fr: "Laisser votre famille revoir vos cartes ?" },
  "share.againyes":      { en: "Yes, share again",
                           nl: "Ja, weer delen",
                           fr: "Oui, partager" },
  "share.starting":      { en: "Turning sharing back on...",
                           nl: "Delen weer aanzetten...",
                           fr: "Reactivation du partage..." },
  "share.again":         { en: "Sharing is on again.",
                           nl: "Delen staat weer aan.",
                           fr: "Le partage est reactive." },
  "share.againfailed":   { en: "Recall could not turn it back on. Try again when you have a connection.",
                           nl: "Recall kon het niet weer aanzetten. Probeer opnieuw met verbinding.",
                           fr: "Recall n'a pas pu le reactiver. Reessayez avec une connexion." },
  "share.stopfailed":    { en: "Recall could not turn it off. Nothing has changed, so try again when you have a connection.",
                           nl: "Recall kon het niet uitzetten. Er is niets veranderd, probeer opnieuw met verbinding.",
                           fr: "Recall n'a pas pu le desactiver. Rien n'a change, reessayez avec une connexion." },
  "hw.title":            { en: "Sharing has been turned off",
                           nl: "Delen is uitgezet",
                           fr: "Le partage a ete desactive" },
  "hw.body":             { en: "The permission for the family to see these cards has been taken back, so there is nothing here to show. Nothing has been deleted: the cards are still on the phone they belong to.",
                           nl: "De toestemming om deze kaarten te zien is ingetrokken, dus hier is niets te zien. Er is niets verwijderd: de kaarten staan nog op de telefoon waar ze horen.",
                           fr: "L'autorisation de voir ces cartes a ete retiree, il n'y a donc rien a afficher. Rien n'a ete supprime : les cartes sont toujours sur le telephone auquel elles appartiennent." },
  "hw.how":              { en: "Sharing can be turned back on from that phone at any time: Recall, the question mark, then sharing with your family.",
                           nl: "Delen kan op die telefoon altijd weer aan: Recall, het vraagteken, dan delen met je familie.",
                           fr: "Le partage peut etre reactive depuis ce telephone a tout moment : Recall, le point d'interrogation, puis le partage avec la famille." },
  "hw.recheck":          { en: "Check again",
                           nl: "Opnieuw kijken",
                           fr: "Verifier de nouveau" },
  ...
  "run.deletefailed":    { en: "Recall could not remove it. It is still shared with your family, so try again when you have a connection.",
                           nl: "Recall kon het niet verwijderen. Het staat nog bij je familie, probeer opnieuw met verbinding.",
                           fr: "Recall n'a pas pu le retirer. Il est toujours partage avec votre famille, reessayez avec une connexion." },
  ...
  "filter.noneon":       { en: "Nothing is switched on. Press one of the buttons above.",
                           nl: "Er staat niets aan. Druk op een van de knoppen hierboven.",
                           fr: "Rien n'est activé. Appuyez sur l'un des boutons ci-dessus." },
  ...
  "list.readleft":       { en: "Read what is still to do",
                           nl: "Lees voor wat nog moet",
                           fr: "Lire ce qui reste a faire" },
  "list.itemdone":       { en: "{item}, done",
                           nl: "{item}, klaar",
                           fr: "{item}, fait" },
  "list.removeask":      { en: "Take {item} off the list?",
                           nl: "{item} van de lijst halen?",
                           fr: "Retirer {item} de la liste ?" },
  "list.removeyes":      { en: "Yes, take it off",
                           nl: "Ja, haal het weg",
                           fr: "Oui, retirer" },
  ...
  /* The rows and buttons in the family app. These were written straight into
     ...
     every one of the little sentences a list shows when it is empty. R2.14. */
  "hrow.since":          { en: "since {when}", nl: "sinds {when}", fr: "depuis {when}" },
  "hrow.linkedon":       { en: "linked {when}", nl: "gekoppeld {when}", fr: "relié {when}" },
  "hrow.helper":         { en: "helper", nl: "helper", fr: "aidant" },
  "hrow.someone":        { en: "someone", nl: "iemand", fr: "quelqu'un" },
  "hrow.thephone":       { en: "the phone", nl: "de telefoon", fr: "le téléphone" },
  "hrow.acard":          { en: "a card", nl: "een kaart", fr: "une fiche" },
  "hrow.coming":         { en: "coming", nl: "komt", fr: "à venir" },
  "hrow.missed":         { en: "missed", nl: "gemist", fr: "manqué" },
  "hrow.done":           { en: "done", nl: "gedaan", fr: "fait" },
  "hrow.markdone":       { en: "Mark done", nl: "Zet op gedaan", fr: "Marquer fait" },
  "hrow.open":           { en: "Open", nl: "Openen", fr: "Ouvrir" },
  "hrow.delete":         { en: "Delete", nl: "Verwijderen", fr: "Supprimer" },
  "hrow.remove":         { en: "Remove", nl: "Verwijderen", fr: "Retirer" },
  "hrow.restore":        { en: "Restore", nl: "Terugzetten", fr: "Restaurer" },
  "hrow.edit":           { en: "Edit", nl: "Aanpassen", fr: "Modifier" },
  "hrow.bin":            { en: "Bin", nl: "Prullenbak", fr: "Corbeille" },
  "hrow.yes":            { en: "Yes", nl: "Ja", fr: "Oui" },
  "hrow.nohousehold":    { en: "You are not part of a household yet. Set one up below.",
                           nl: "U hoort nog bij geen enkel huishouden. Maak er hieronder een aan.",
                           fr: "Vous ne faites encore partie d'aucun foyer. Créez-en un ci-dessous." },
  "hrow.nocards":        { en: "No cards yet. Add the first one and it will be read out loud.",
                           nl: "Nog geen kaarten. Voeg de eerste toe en die wordt voorgelezen.",
                           fr: "Pas encore de fiches. Ajoutez la première et elle sera lue à voix haute." },
  "hrow.binempty":       { en: "The bin is empty.", nl: "De prullenbak is leeg.", fr: "La corbeille est vide." },
  "hrow.nophone":        { en: "No phone is linked yet. Set one up below.",
                           nl: "Er is nog geen telefoon gekoppeld. Stel er hieronder een in.",
                           fr: "Aucun téléphone n'est encore relié. Configurez-en un ci-dessous." },
  "hrow.nooldphone":     { en: "There is no older phone to remove.",
                           nl: "Er is geen oudere telefoon om te verwijderen.",
                           fr: "Il n'y a pas d'ancien téléphone à retirer." },
  "hrow.onlynew":        { en: "Only the new phone is linked now.",
                           nl: "Alleen de nieuwe telefoon is nu gekoppeld.",
                           fr: "Seul le nouveau téléphone est relié maintenant." },
  "hrow.nohistory":      { en: "Nothing has happened yet.",
                           nl: "Er is nog niets gebeurd.",
                           fr: "Rien ne s'est encore passé." }
};
