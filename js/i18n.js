...
const WORDS = {
  ...
  "better.hint":         { en: "Recall can read with a much more natural voice. It has to be downloaded once, it is about {mb} MB, and it then works with no internet at all. It runs on this device: nothing you have Recall read is ever sent anywhere.",
                           nl: "Recall kan voorlezen met een veel natuurlijkere stem. Die moet één keer gedownload worden, ongeveer {mb} MB, en werkt daarna helemaal zonder internet. Ze werkt op dit toestel: niets van wat je laat voorlezen wordt ooit ergens naartoe gestuurd.",
                           fr: "Recall peut lire avec une voix beaucoup plus naturelle. Elle doit être téléchargée une fois, environ {mb} MB, et fonctionne ensuite sans aucune connexion. Elle tourne sur cet appareil: rien de ce que vous faites lire n'est jamais envoyé ailleurs." },
  "better.use":          { en: "Use the better voice",
                           nl: "De betere stem gebruiken",
                           fr: "Utiliser la meilleure voix" },
  "better.get":          { en: "Download the voice for this language, {mb} MB",
                           nl: "De stem voor deze taal downloaden, {mb} MB",
                           fr: "Télécharger la voix pour cette langue, {mb} MB" },
